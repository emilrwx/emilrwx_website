    ...
    <>
      ...
      <main>
        ...
        <ul>
          ...
          <li>I also write my thoughts in markdown using Vim. I made <a href='https://github.com/emilnuutinen/dotfiles_mac/tree/master/.scripts'>scripts</a> to automate my daily journals and weekly reflections.</li>
        ...
        <b>Desktop Setup (for dev only)</b>
        <ul>
